...
- **Learning strategies**: Zero-shot, one-shot (correct and incorrect configuration), and few-shot (4 weeks & 30 days) learning.  
...
> **Note**: To enhance readability and reduce excessive scrolling, lengthy outputs from test and training cells have been removed.
